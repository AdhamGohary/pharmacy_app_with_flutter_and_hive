    ...
    if (myBox.keys.contains(chemicalController.text.toUpperCase().trim()) &&
      ...
      if (index > 1 && hasAdham) {
        ...
        setState(() {
          ...
          //     .gramsOfChemical -= double.parse(amountController.text);
          // //myBox
          //     .get(chemicals[chemicals.indexOf(e)]['nameOfChemical'].toString().toUpperCase().trim())
          //     .gramsOfChemical -= double.parse(amountController.text);
          // myBox
          //     .get(chemicalController.text.toUpperCase().trim())
          //     .kiloOfChemical -= double.parse(amountController.text) / 1000;
        ...
        for (final e in chemicals) {
          ...
          myBox
              .get(chemicals2[chemicals2.indexOf(e)]['nameOfChemical']
                  ...
                  .toUpperCase()
                  .trim())
              .gramsOfChemical -= chemicals2[chemicals2.indexOf(e)]['amountOfChemical'];
          myBox
              .get(chemicals2[chemicals2.indexOf(e)]['nameOfChemical']
                  .toString()
                  .toUpperCase()
                  .trim())
              .kiloOfChemical -= chemicals2[chemicals2.indexOf(e)]['amountOfChemical'] / 1000;
        }
          ...
          Padding(
            ...
            child: ListView(
              ...
              children: [
                ...
                Padding(
                  padding:
                      EdgeInsets.only(top: 0.04 * getHeight(context: context)),
                  child: CustomBtn(
